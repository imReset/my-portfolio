      ...
      <div className="flex flex-col justify-center items-center w-full h-full">
        <div className="max-w-[1000px] w-full grid grid-cols-2 gap-8">
          <div className="sm:text-right pb-8 pl-4">
            <p className="text-8xl font-black inline text-[#203368] 	">about.</p>
          </div>
        </div>
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-right text-4xl font-bold text-[#03045E]">
            <h1 class="w-full text-3xl font-semibold block text-center pl-15 pb-10">
              Hi Clint, make some noise, Please take a look around
            </h1>
            <p class="w-full text-3xl font-semibold block text-center  pb-10 content-center	">
